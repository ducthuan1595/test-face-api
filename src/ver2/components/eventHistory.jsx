...
function EventHistory() {
  ...
  const sortedData = data.sort((a, b) => {
    const dateA = new Date(a.sukien[0].real_time);
    const dateB = new Date(b.sukien[0].real_time);
    return dateB - dateA;
  });
          ...
          {currentResults.map((array, index) => (
            ...
            >
              ...
              <div className="flex flex-col w-40 h-[100%] justify-center items-center ">
                <div
                  style={{
                    backgroundImage: `url(${array.sukien[0].link_nam_goc})`,
                  }}
                  alt=""
                ...
                <div
                  style={{
                    backgroundImage: `url(${array.sukien[0].link_nu_goc})`,
                  }}
                  alt=""
                  className="w-44 h-40 rounded-[50%] bg-red-400 bg-center bg-no-repeat bg-cover"
                />
              ...
              <div
                style={{
                  backgroundImage: `url(${array.sukien[0].link_da_swap})`,
                }}
